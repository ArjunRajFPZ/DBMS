...
b. Display the staffs who earn maximum salary from each department.
c. Display staff whose salary> 25000 and city same as his/her student.
d. Display all employee details that belongs to that company having no of employees is maximum.
e. Update the employee salary by 8% who belongs to 'Ernakulam' whose designation is 'clerk' and city as same as where he works.
